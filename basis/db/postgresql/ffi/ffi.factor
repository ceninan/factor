...
! PQresultErrorField() field codes
CONSTANT: PG_DIAG_SEVERITY                  CHAR: S
CONSTANT: PG_DIAG_SQLSTATE                  CHAR: C
CONSTANT: PG_DIAG_MESSAGE_PRIMARY           CHAR: M
CONSTANT: PG_DIAG_MESSAGE_DETAIL            CHAR: D
CONSTANT: PG_DIAG_MESSAGE_HINT              CHAR: H
CONSTANT: PG_DIAG_STATEMENT_POSITION        CHAR: P
CONSTANT: PG_DIAG_INTERNAL_POSITION         CHAR: p
CONSTANT: PG_DIAG_INTERNAL_QUERY            CHAR: q
CONSTANT: PG_DIAG_CONTEXT                   CHAR: W
CONSTANT: PG_DIAG_SOURCE_FILE               CHAR: F
CONSTANT: PG_DIAG_SOURCE_LINE               CHAR: L
CONSTANT: PG_DIAG_SOURCE_FUNCTION           CHAR: R
